...
public final class CMPT456Analyzer extends StopwordAnalyzerBase {
  ...
  static {
    // use the default stopwords if fail to read in stopwords.txt
    ...
    try {
      stopWords = Files.readAllLines(Paths.get("/lucene-solr/lucene/demo/src/java/org/apache/lucene/demo/stopwords.txt"));
      System.out.println("Successfully read in stopwords.txt");
    } catch (IOException e) {
      System.out.println("Failed to read in stopwords.txt");
    }
  ...
  protected TokenStreamComponents createComponents(final String fieldName) {
    ...
    // edit stopwrods above such that it reads in the list of stopwords
    tok = new StopFilter(tok, stopwords);
    // use a porter stemmer filterr on the tokens
